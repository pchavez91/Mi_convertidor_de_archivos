  ...
  return (
    <div className="min-h-screen bg-zinc-950">
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto bg-zinc-900/50 backdrop-blur-md border border-white/10 rounded-2xl shadow-2xl p-8 md:p-12">
          <h1 className="text-4xl font-bold text-white mb-6 bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">
          ...
          <div className="prose prose-lg max-w-none prose-invert">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-white mb-4">6. Limitaciones de Uso</h2>
              <p className="text-zinc-300 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-white mb-4">7. Modificaciones del Servicio</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-white mb-4">8. Enlaces a Terceros</h2>
              <p className="text-zinc-300">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-white mb-4">9. Cambios a los Términos</h2>
              <p className="text-zinc-300">
          ...
          <div className="mt-8 pt-6 border-t border-white/10">
            <a 
              href="/"
              className="inline-block bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-6 py-3 rounded-lg hover:from-indigo-700 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105"
            >
