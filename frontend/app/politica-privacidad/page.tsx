      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto bg-zinc-900/50 backdrop-blur-md border border-white/10 rounded-2xl shadow-2xl p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none prose-invert">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-white mb-4">2. Uso de Archivos</h2>
              <p className="text-zinc-300 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-white mb-4">3. Cookies y Tecnologías de Seguimiento</h2>
              <p className="text-zinc-300 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-white mb-4">4. Servicios de Terceros</h2>
              <p className="text-zinc-300 mb-4">
